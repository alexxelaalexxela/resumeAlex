                ...
                <div className="flex flex-col items-center gap-y-6 rounded-xl p-6 text-center shadow-lg backdrop-blur-sm">
                    ...
                    <div className={classNames('col-span-1 flex flex-col gap-y-6 text-center items-center ', { 'md:col-span-3': !!profileImageSrc })}>
                        <div className="flex flex-col items-center">
                            <h2 className="text-3xl font-bold text-white items-center text-center">Spatial reasoning from LLM for global navigation</h2>
                        </div>
                        <ul className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <li className="col-span-1 flex  items-start gap-x-2">
                                ...
                                <span className=" text-sm text-gray-300">LLM, API, Python</span>
                            </li>
                ...
                <div className="flex flex-col divide-y-2 divide-neutral-300">
                    <div className="grid grid-cols-1 gap-y-4 py-8 first:pt-0 last:pb-0  md:grid-cols-4">
                        ...
                        <div className="col-span-1 flex flex-col md:col-span-3">
                            <span>The goal of this semester project is to leverage the versatility of Large Language Models (LLMs) to enable robotic navigation across diverse and dynamic environments. </span>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 gap-y-4 py-8 first:pt-0 last:pb-0  md:grid-cols-4">
                        <div className="col-span-1 flex justify-center md:justify-start">
                        ...
                        <div className="col-span-1 flex flex-col md:col-span-3">In order to improve robot’s navigation and to make it more versatile in various different environment, we are testing the spatial reasoning capabilities of large language models. The goal is to test whether the robot can have spatial reasoning with GPT-4 API and what is the strength and weakness of LLM, then test it with ANYmal robot.
                        </div>
                    </div>
