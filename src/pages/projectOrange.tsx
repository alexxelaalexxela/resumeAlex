                ...
                <div className="flex flex-col items-center gap-y-6 rounded-xl p-6 text-center shadow-lg backdrop-blur-sm">
                    ...
                    <div className={classNames('col-span-1 flex flex-col gap-y-6 text-center items-center ', { 'md:col-span-3': !!profileImageSrc })}>
                        <div className="flex flex-col items-center">
                            <h2 className="text-3xl font-bold text-white items-center text-center">Mechanical Design</h2>
                        </div>
                        <ul className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <li className="col-span-1 flex items-start gap-x-2 ">
                                ...
                                <span className=" text-sm text-gray-300">Lausanne, Switzerland</span>
                            </li>
                            <li className="col-span-1 flex  items-start gap-x-2">
                                <CalendarIcon className="h-5 w-5 text-white" />
                                <span className="text-sm font-bold text-white">Date :</span>
                                <span className=" text-sm text-gray-300"> 01/2022 - 06/2022 </span>
                            </li>
                            <li className="col-span-1 flex  items-start gap-x-2">
                                <BuildingOffice2Icon className="h-5 w-5 text-white" />
                                <span className="text-sm font-bold text-white">Institution :</span>
                                <span className=" text-sm text-gray-300">EPFL</span>
                            </li>
                            <li className="col-span-1 flex  items-start gap-x-2">
                                <AcademicCapIcon className="h-5 w-5 text-white" />
                                <span className="text-sm font-bold text-white">Skills :</span>
                                <span className=" text-sm text-gray-300">Mechanical design, CATIA, Brainstorming</span>
                            </li>
            ...
            <Section className="bg-neutral-100" sectionId='resume'>
                ...
                <div className="flex flex-col divide-y-2 divide-neutral-300">
                    ...
                    <div className="grid grid-cols-1 gap-y-4 py-8 first:pt-0 last:pb-0  md:grid-cols-4">
                        ...
                        <div className="col-span-1 flex flex-col md:col-span-3">Brainstorming and designing with CATIA a orange press like commercial juicers. The objective is to have a complete and ready to use product that respect the load specifications.</div>
                    </div>
